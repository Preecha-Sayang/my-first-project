  ...
  <div className="flex flex-col justify-center items-center w-[100%] my-[120px] md:my-[120px] px-4">
    <div   id="hero-sction"  className="flex flex-col  items-center 
      ...
      <div id="right-content" className="w-full md:w-1/3 text-center md:text-right flex flex-col gap-4">
        <h1 className="!text-xl md:!text-4xl !font-bold" >Stay Informed, Stay Inspired</h1>
      ...
      <img src="./herosection.png" alt="hero-section-img"  className="w-[250px] h-[300px] md:w-1/3 md:h-[530px] object-contain"/>

      <div id="left-content " className="w-full md:w-1/3 flex flex-col gap-4 text-center md:text-left">
        <div id="author">
