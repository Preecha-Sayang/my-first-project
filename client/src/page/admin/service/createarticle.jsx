...
export default function CreateArticle() {
  const [thumbnailFile, setThumbnailFile] = useState(null); // 👈 ใหม่
...
const uploadThumbnailToSupabase = async (postId) => {
  ...
  formData.append("postImage", thumbnailFile);
  formData.append("postId", postId); // ✅ ส่ง postId ไป
...
const handleSubmit = async (status) => {
  try {
    ...
    const status_id = status === "published" ? 1 : 2;
  ...
  return (
    <div className="min-h-screen bg-gray-50 p-8">
      <div className="p-6 border-b flex justify-between items-center">
        <p className="text-xl font-semibold">Create article</p>
        ...
        <div className="mb-6">
          ...
          <div className="flex flex-row items-end gap-[50px]">
            <div className="relative">
              {!thumbnailUrl ? (
                <div className="border-2 border-dashed border-gray-300 rounded-lg p-8 bg-gray-50 w-[450px] h-[250px]
